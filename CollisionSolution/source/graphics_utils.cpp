...
void UpdateFrame(Uint64 frame_start, std::vector<Body> &local_bodies, const unsigned int X_OFFSET, const unsigned int X_BUFFER, const unsigned int HEIGHT, int rank, int n_proc, bool &keep_going)
{
